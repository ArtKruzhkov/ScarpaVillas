    ...
    <section className="overflow-hidden">
          ...
          <motion.div
            ...
            <AnimatePresence mode="wait">
              <motion.h2
                ...
                className="text-center font-serif text-[18px] leading-[22px] tracking-[0.1em] text-[#2C3654] uppercase sm:text-[28px] sm:leading-[32px] md:text-[32px] md:leading-[36px] xl:text-[38px] xl:leading-[42px]">
          ...
          <motion.div
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="space-y-5 text-center font-sans text-[13px] leading-[1.4] sm:text-[15px] lg:text-[18px]">
      ...
      <div className="bg-[#F0E7DA] py-8">
        <div className="mx-auto grid max-w-8xl lg:grid-cols-2">
          {/* LEFT */}
          <motion.div
            className="relative min-h-[500px] overflow-hidden sm:min-h-[620px] lg:min-h-[720px] 2xl:min-h-[760px]"
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.25 }}
            transition={{
            ...
            <motion.div
              ...
              <AnimatePresence mode="wait">
                <motion.h3
                  ...
                  className="text-center font-serif text-[32px] md:text-[38px] leading-[1.15] tracking-[0.06em] text-white uppercase">
            ...
            <motion.div
              ...
              <AnimatePresence mode="wait">
                <motion.h3
                  ...
                  className="text-center font-sans text-[18px] 2xl:text-[20px] font-semibold leading-[1.4] tracking-[0.2em] text-[#2C3654] uppercase">
            ...
            <motion.div
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="space-y-6 text-center font-sans text-[13px] leading-[1.4] text-[#2C3654] sm:text-[15px] lg:text-[18px]">
