    ...
    <section className="relative section-height overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col justify-between items-center">
        ...
        <motion.p
          ...
          className="pb-10 lg:pb-12 text-center font-serif text-[22px] leading-[28px] sm:text-[28px] sm:leading-[34px] lg:text-[32px] lg:leading-[38px] text-white max-w-[350px] sm:max-w-[510px] lg:max-w-[600px]">
