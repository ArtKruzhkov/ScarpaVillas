  ...
  return (
    <section id="plan" className="relative section-height w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center lg:justify-end px-4 sm:px-6 pb-10 md:pb-14 xl:pb-24 text-center text-white">
        <h2 className="font-serif uppercase tracking-[0.08em] text-[28px] leading-[36px] sm:text-[38px] sm:leading-[46px] lg:text-[48px] lg:leading-[56px] xl:text-[57px] xl:leading-[68px]">
          Your Place In Barolo Awaits
        </h2>

        <p className="mt-4 lg:mt-6 xl:mt-8 max-w-[920px] font-serif text-[18px] leading-[28px] sm:text-[24px] sm:leading-[34px] lg:text-[32px] lg:leading-[44px] xl:text-[34px] xl:leading-[50px]">
